...
1919 年时值日全食，因此能够观察到太阳附近的星星，由亚瑟·爱丁组织的两支观测队伍分别前往非洲几内亚海湾的普林西比岛和巴西北部的索布拉尔，非洲测出是$1.61''$，而巴西是$1.98''$，将理论预测值包含到区间里，而此后多年观测的平均值在$1.89''$左右，与广义相对论基本符合。
...
$$2\times(\frac{\partial u}{\partial \varphi})(\frac{\partial^2 u}{\partial \varphi^2})=0-2u(\frac{\partial u}{\partial \varphi})-0+6GMu^2(\frac{\partial u}{\partial \varphi})+2(\frac{\partial u}{\partial \varphi})\frac{GM}{\tilde{L}^2}$$
...
根据和角公式和三角函数的泰勒展开，忽略高阶项可以得到

$$u\approx\frac{GM}{\tilde{L}^2}[1+e\cos{((1-\frac{3G^2M^2}{\tilde{L}^2})\varphi)}]=\frac{GM}{\tilde{L}^2}+\frac{GMe}{\tilde{L}^2}[\cos{\varphi}(1-(\not{\frac{1}{2}\frac{3G^2M^2}{\tilde{L}^2}\varphi}})^2+\sin{\varphi}\frac{3G^2M^2}{\tilde{L}^2}\varphi]$$
