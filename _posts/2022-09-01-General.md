...
$$2\times(\frac{\partial u}{\partial \varphi})(\frac{\partial^2 u}{\partial \varphi^2})=0-2u(\frac{\partial u}{\partial \varphi})+6GMu^2(\frac{\partial u}{\partial \varphi})$$
...
它的解就是行星运动轨道的曲线，解得一个极坐标下的圆锥方程，偏心率是$e$，当$e$
