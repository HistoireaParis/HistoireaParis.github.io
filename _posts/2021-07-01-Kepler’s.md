...
<script type="text/javascript" src="/js/post6/animateSpiral.js"></script>
<script type="text/javascript" src="/js/post6/CopernicusDriver.js"></script>
<script type="text/javascript" src="/js/post6/PtolemyGhostingDriver.js"></script>
<script type="text/javascript" src="/js/post6/TychoBraheDriver.js"></script>

<canvas id="ptolemysModel" width="460" height="320" style="background-color:#000030;">                        
                        <img src="images/PtolemyModel.gif" alt="Ptolemy's model of epicycles">
</canvas>
