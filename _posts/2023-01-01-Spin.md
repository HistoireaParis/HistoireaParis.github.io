...
$$(i\hbar\gamma^0\partial_t+i\hbar\gamma^i\partial_i-mc)\psi=(i\hbar\gamma^{\mu}\partial_{\mu}-mc)\psi$$
...
可以验证，$\gamma^{\mu}$是四个反对易矩阵，其关系满足$\left\{ \gamma^{\mu},\gamma^{\nu}\right\}=-2\eta^{\mu\nu}$，
...
而对应的波函数解也是四维列向量，称作[旋量](https://zh.wikipedia.org/wiki/%E6%97%8B%E9%87%8F)(**Spinor**)
