...
如果$\sigma_1\sigma_2+\sigma_2\sigma_1=2\sigma_1\sigma_2=0$满足交换律，那么$\sigma_1$或$\sigma_2$为零，这四个等式不能同时被满足。问题可能就出现在这个交换律上，我们其实根据上式知道
...
这个关系多么像三个单位矩阵之间的互相作用，这三个单位矩阵就是[泡利矩阵](https://zh.wikipedia.org/wiki/%E6%B3%A1%E5%88%A9%E7%9F%A9%E9%99%A3)
