...
$$\sqrt{a^2+b^2+c^2+d^2}=\alpha_1a+\alpha_2b+\alpha_3c+\betad$$
...
$$i\hbar\frac{\partial \psi}{\partial t}=H\psi=\sqrt{\mathbf{pc}^2+(mc^2)^2}\psi=[c(\alpha_1p_1+\alpha_2p_2+\alpha_3p_3)+\beta mc^2]\psi$$
